...
class V2XSimulator:
    ...
    def start(self, vehicle_list: List[Dict]):
        """
    ...
    def _update_and_send(self):
        for v in self.vehicles:
            ...
            try:
                # Use a timeout to avoid blocking the loop too long
                requests.post(f"{self.api_url}/telemetry", json=payload, timeout=0.5)
            except Exception as e:
                # Silently fail for demo simulation
                pass
